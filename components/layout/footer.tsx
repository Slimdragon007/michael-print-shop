        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 py-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground text-sm">
              Transform your digital memories into beautiful, high-quality prints. 
              From metal and canvas to fine art paper, we bring your photos to life.
            </p>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/care-instructions" className="text-muted-foreground hover:text-primary">
                  Care Instructions
                </Link>
              </li>
              <li>
                <Link href="/custom-orders" className="text-muted-foreground hover:text-primary">
                  Custom Orders
                </Link>
              </li>
            </ul>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3 text-sm text-muted-foreground">
              <div className="flex items-center space-x-2">
                ...
                <span>support@printshop.com</span>
              </div>
              <div className="flex items-center space-x-2">
                <Phone className="h-4 w-4" />
                <span>1-800-PRINT-99</span>
              </div>
              <div className="flex items-center space-x-2">
        ...
        <div className="border-t py-6">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-sm text-muted-foreground">
              © 2024 PrintShop. All rights reserved.
            </p>
